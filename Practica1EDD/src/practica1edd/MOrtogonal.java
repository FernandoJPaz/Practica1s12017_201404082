    ...
    public void linealizarColumnas() {
        ...
        while (faux != null) {
            while (caux != null) {
                ...
                boton = new JButton();
                boton.setBounds(faux.posx * 25, faux.posy * 25, 25, 25);
                jue.add(boton);
...
//            fichero = new FileWriter("C:\\Users\\Fernando\\Desktop\\MatrizOrtogonal.txt");
    ...
    public void Graficar (){
        ...
        try{
            ...
            pw.append("Digraph G {\n");
            pw.append("Subgraph cluster_0{style= \"filled\"; fillcolor= \"#F3E2A9\"; label = \"MATRIZ\"; rankdir=left;\n");
            pw.append("node [shape=rect color=blue style=\"filled\" fillcolor=\"#F2F2F2\"];\n");
            ...
            while(caux!=null){
                while(faux!=null){
                   /* pw.append("nodo" + (faux.posx+1) + (faux.posy+1)+" [label=\" " +faux.valor.toString() + " /n ("+faux.posx+faux.posy+"); /n pos="+faux.posx+faux.posy+" /n\"];\n");
                    pw.append("nodo" + (faux.posx+1) + (faux.posy+1)+" [label=\" " +faux.valor.toString() + " /n ("+faux.posx+faux.posy+") /n\"];");
                    pw.append("nodo" + (faux.posx+1) + (faux.posy+1)+ );
                    label=\"" + pos.getPosx() + "," + pos.getPosy() + "\"; pos= \"" + nncolumna + "," + nnfila + "!\"];\n");
                    */
                   pw.append("nodo" + (faux.posx+1) + (faux.posy+1)+" [label=\" " +faux.valor.toString() + " /n ("+faux.posx+faux.posy+") /n\"; pos= \"" + faux.posx + "," + faux.posy + "!\"];\n");
                    faux=faux.siguiente;
                }
                caux=caux.abajo;
                faux=caux;
